...
var (
	...
	catalogQuantNameRE           = regexp.MustCompile(`(?i)(^|[-_./])(gguf|ggml|gptq|awq|exl[2-9]|quantized?|qat|(?:amx)?int[248]|[248][-_]?bits?|fp8|bnb)([-_./]|$)`)
	catalogConvertNameRE         = regexp.MustCompile(`(?i)(^|[-_./])(convert|converted|conversion|mlx|onnx|openvino|tensorrt|coreml|tilert)([-_./]|$)`)
